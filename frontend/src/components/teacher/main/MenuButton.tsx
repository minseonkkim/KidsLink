...
export default function MenuButton({ name, imgpath }: MenuButtonProps) {
    return (
        <>
            <div className="drop-shadow-md cursor-pointer flex flex-col items-center justify-center w-[200px] h-[200px] max-sm:w-[130px] max-sm:h-[130px] rounded-[20px] bg-[#fff9d7] m-[25px] max-sm:m-[18px] hover:bg-[#F6F0CF] group">
