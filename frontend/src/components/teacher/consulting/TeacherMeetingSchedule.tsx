...
export default function TeacherMeetingSchedule({date, time, name, profileImgPath, isActivate}:TeacherMeetingScheduleProps){
    return <>
        <div className={`w-[340px] h-[230px] m-[25px] ${isActivate? 'bg-gradient-to-br from-[#FFF9D7] to-[#D5E4B4]' : 'bg-[#f4f4f4]'} rounded-[20px] flex flex-col items-center justify-around p-5`}>
            ...
            <div className="flex flex-row items-center">
                ...
                <p className="font-bold text-[24px]">{name} 학부모님</p>
            </div>
            <div>
