...
export default function TeacherMeetingMain(){
    ...
    <div className="mt-[130px] px-[130px]">
        ...
        <Title title="화상상담" />
        <div className="flex flex-row justify-center mt-[95px]">
            ...
            <MeetingMainButton title="상담시간 확정" description="키즈링크만의 알고리즘으로 최대한 많은 학부모와 상담을 할 수 있도록 상담 시간을 확정해드려요." link="/meeting/confirm" image={CheckImg} imgWidth={218} imgTop={140} imgLeft={170}/>
