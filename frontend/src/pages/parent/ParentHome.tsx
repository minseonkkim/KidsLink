...
export default function ParentHome() {
  ...
  return (
    <div className="flex flex-col bg-[#FFEC8A]">
      ...
      <div className="w-full flex flex-col justify-center items-center rounded-tl-[20px] rounded-tr-[20px] bg-white shadow-top px-6 flex-grow">
        <p className="text-center text-[18px] my-6 p-2 font-medium">
          유치원과의 편리한 소통
        </p>
