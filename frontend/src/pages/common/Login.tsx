      ...
      <section className="fourth-section min-h-screen flex items-center justify-center bg-gray-100">
        ...
        >
          ...
          <div className="flex justify-center mt-8">
            <FaChevronUp onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-[24px] text-[#b1b1b1] cursor-pointer hover:text-gray-800 transition-colors duration-200"/>
          </div>
        </motion.div>
      </section>
    </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mx-[150px] py-[97px]">
            ...
            <form className="flex flex-col" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="w-[430px] h-[56px] rounded-[18px] bg-[#FFE96F] hover:bg-[#FFD700] text-[23px] text-[#363636] font-bold mb-5 transform hover:scale-105 transition-transform duration-200"
              >
                로그인
              </button>
            </form>
          ...
          <div className="flex justify-center h-[50px]">
            <FaChevronDown onClick={scrollToLandingPage} className="text-[24px] text-[#b1b1b1] cursor-pointer hover:text-gray-800 transition-colors duration-200"/>
          </div>
        </div>
      </div>
      <LandingPage />
        ...
        {isContentVisible ? (
          ...
          <div>
            <form className="flex flex-col" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="w-[330px] h-[55px] rounded-[20px] bg-[#ffe96f] text-[23px] font-bold mb-5 transform hover:scale-105 transition-transform duration-200"
              >
                로그인
              </button>
            </form>
